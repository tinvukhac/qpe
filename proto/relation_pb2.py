...
_RELATION_HISTOGRAMBIN = _descriptor.Descriptor(
  name='HistogramBin',
  full_name='qpe.proto.Relation.HistogramBin',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='from', full_name='qpe.proto.Relation.HistogramBin.from', index=0,
      number=1, type=1, cpp_type=5, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='to', full_name='qpe.proto.Relation.HistogramBin.to', index=1,
      number=2, type=1, cpp_type=5, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='freq', full_name='qpe.proto.Relation.HistogramBin.freq', index=2,
...
_RELATION = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='rowSize', full_name='qpe.proto.Relation.rowSize', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='cumulativeCost', full_name='qpe.proto.Relation.cumulativeCost', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='result', full_name='qpe.proto.Relation.result', index=5,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='bins', full_name='qpe.proto.Relation.bins', index=6,
  ...
  nested_types=[_RELATION_CUMULATIVECOST, _RELATION_HISTOGRAMBIN, ],
  enum_types=[
    _RELATION_OPCODE,
  ],
  options=None,
...
_RELATION_HISTOGRAMBIN.containing_type = _RELATION;
...
_RELATION.fields_by_name['bins'].message_type = _RELATION_HISTOGRAMBIN
...
class Relation(_message.Message):
  ...
  class HistogramBin(_message.Message):
    __metaclass__ = _reflection.GeneratedProtocolMessageType
    DESCRIPTOR = _RELATION_HISTOGRAMBIN

    # @@protoc_insertion_point(class_scope:qpe.proto.Relation.HistogramBin)
